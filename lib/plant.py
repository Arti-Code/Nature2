...
class Plant(Life):
    ...
    def create_timers(self):
        ...
        repro: Timer = Timer(60, False, True, "repro", True)

        self.timer["repro"] = repro
    ...
    def check_reproduction(self) -> bool:
        if not self.repro_time:

            return False
        self.repro_time = False
